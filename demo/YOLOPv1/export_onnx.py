...
from libs.models.common import Conv, SPP, Bottleneck, BottleneckCSP, Focus, Concat, Detect, SharpenConv
from torch.nn import Upsample
from libs.utils import check_anchor_order
from libs.utils import initialize_weights
import argparse
import onnx
...
<<<<<<< HEAD
    parser.add_argument('--name', type=str, default="")  # width
=======
    parser.add_argument('--name', type=str, default="End-to-end.pth")  # width
>>>>>>> e1ed87fb6c3f23d2dcf78780ef007e8821593c92
...
<<<<<<< HEAD
    name = args.name
    checkpoint = torch.load('./weights/'+name, map_location=device)
=======
    checkpoint = torch.load('./weights/'+args.name, map_location=device)
>>>>>>> e1ed87fb6c3f23d2dcf78780ef007e8821593c92
    model.load_state_dict(checkpoint['state_dict'])
    model.eval()
    
    #model  = torch.jit.load('./weights/'+args.name)
    #model = model.cpu()
    #model.eval()
    ...
    width = args.width
<<<<<<< HEAD
    print("Load ./weights/"+name+" done!")
    onnx_path = f'./weights/yolop-{height}-{width}.onnx'
=======
    print("Load ./weights/"+args.name+" done!")
    onnx_path = f'./weights/'+args.name+'.onnx'
>>>>>>> e1ed87fb6c3f23d2dcf78780ef007e8821593c92
