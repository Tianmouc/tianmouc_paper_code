...
import numpy as np
from libs.utils import DataLoaderX, torch_distributed_zero_first
...
from libs.utils import run_anchor
...
def main():
    ...
    checkpoint_file = './weights/End-to-end.pth'
